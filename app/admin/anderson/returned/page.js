...
export default function ReturnedOrdersPage() {
  ...
  const fetchReturnedOrders = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/orders/anderson/returned?${params}`);
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Orders that were returned to sender
          </p>
        </div>
        ...
        {loading ? (
          <div className="text-center py-12">
            ...
            <p className="mt-2 text-gray-500">Loading returned orders...</p>
          </div>
          ...
          <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
            ...
            <p className="text-gray-500">No orders have been returned yet</p>
          </div>
        ) : (
          <>
                      ...
                      <tr key={order._id} className="hover:bg-gray-50">
                        <td className="px-6 py-4">
                          ...
                          <div className="flex items-center gap-1.5 mt-1">
                            <ArrowUturnLeftIcon className="w-4 h-4 text-orange-500" />
                        ...
                        <td className="px-6 py-4 text-sm text-gray-500">
                          {order.return_date ? new Date(order.return_date).toLocaleDateString('en-US', {
                            month: 'short',
                            day: 'numeric',
                            year: 'numeric',
                          }) : 'N/A'}
