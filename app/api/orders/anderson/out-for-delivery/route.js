...
/**
 * GET /api/orders/anderson/out-for-delivery
 * Get orders out for delivery (admin only)
 */
export async function GET(request) {
  try {
    ...
    const filter = { status: 'out-for-delivery' };
    ...
    console.error('[API] Error fetching out-for-delivery orders:', error);
    return NextResponse.json(
